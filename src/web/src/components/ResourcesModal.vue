<template>
  <v-dialog :model-value="show" max-width="600" @update:model-value="onUpdate">
    <v-card>
      ...
      <v-card-text>
          ...
          <v-list density="comfortable" lines="one">
            <v-list-item>
              ...
              <v-list-item-subtitle
                >For immediate emergencies</v-list-item-subtitle
              >
              <template #append>
            ...
            <v-list-item>
              ...
              <v-list-item-subtitle
                >Report crimes anonymously</v-list-item-subtitle
              >
              <template #append>
            ...
            <v-list-item>
              <v-list-item-title
                >Victoria Police Non-Emergency</v-list-item-title
              >
              <v-list-item-subtitle
                >Non-urgent police matters</v-list-item-subtitle
              >
              <template #append>
                <v-chip color="primary" variant="tonal" class="font-weight-bold"
                  >03 9247 6666</v-chip
        ...
        <div>
          ...
          <v-list density="comfortable">
            ...
            >
              <v-list-item-title
                >Theft Prevention Guide (Neighbourhood Watch)</v-list-item-title
              >
              <v-list-item-subtitle
                >Practical tips on how to prevent your motorcycle from
                theft</v-list-item-subtitle
              >
              <template #append>
            ...
            >
              ...
              <v-list-item-subtitle
                >Register your motorcycle for free and report if it's
                stolen</v-list-item-subtitle
              >
              <template #append>
                <v-icon icon="mdi-open-in-new" size="small" />
              </template>
            ...
            >
              <v-list-item-title
                >Stolen Motorcycles Australia (Facebook
                Group)</v-list-item-title
              >
              <v-list-item-subtitle
                >Engage with other riders about stolen
                motorcycles</v-list-item-subtitle
              >
              <template #append>
                <v-icon icon="mdi-open-in-new" size="small" />
              </template>
